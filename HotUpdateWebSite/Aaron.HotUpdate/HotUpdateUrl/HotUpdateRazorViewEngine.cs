...
namespace Aaron.HotUpdate
{
    ...
    /// </remarks>
    public class HotUpdateRazorViewEngine : IRazorViewEngine
    {
        ...
        /// </summary>
        public HotUpdateRazorViewEngine(
            ...
            DiagnosticListener diagnosticListener)
        {
            ...
            if (_options.ViewLocationFormats.Count == 0)
            {
                throw new ArgumentException(
                    "ViewLocationFormats count is 0",
            ...
            {
                throw new ArgumentException(
                    "AreaViewLocationFormats count is 0",
                    nameof(optionsAccessor));
            }
        ...
        public RazorPageResult FindPage(ActionContext context, string pageName)
        {
            ...
            {
                throw new ArgumentException("pageName is empty", nameof(pageName));
            }
        ...
        public RazorPageResult GetPage(string executingFilePath, string pagePath)
        {
            ...
            {
                throw new ArgumentException("pagePath is empty", nameof(pagePath));
            }
        ...
        public ViewEngineResult FindView(ActionContext context, string viewName, bool isMainPage)
        {
            ...
            {
                throw new ArgumentException("viewName is empty", nameof(viewName));
            }
        ...
        public ViewEngineResult GetView(string executingFilePath, string viewPath, bool isMainPage)
        {
            ...
            {
                throw new ArgumentException("viewPath is empty", nameof(viewPath));
            }
            ...
            HashSet<IChangeToken> expirationTokens)
        {
            ...
            foreach (var filePath in HotUpdateRazorFileHierarchy.GetViewStartPaths(path))
            {

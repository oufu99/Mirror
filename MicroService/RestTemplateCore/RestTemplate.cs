...
{
    /// <summary>
    /// 根据传入的自定义名称解析成真实的ip地址,封装了变化方便调用
    /// 把"http://ProductService/api/Product/"这样的虚拟地址按照客户端负载均衡算法解析为 http://192.168.1.10:8080/api/Product/这样的真实地址
    /// </summary>
    public class RestTemplate
    {
       ...
       Uri(ConsulServerUrl)))
        ...
        private async Task<String> ResolveUrlAsync(String url)
        {
            ...
            //查询出来apiservice1 对应的服务器地址 192.168.1.1:5000

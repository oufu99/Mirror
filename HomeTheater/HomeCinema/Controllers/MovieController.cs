...
namespace HomeCinema.Controllers
{
    public class MovieController : Controller
    {
        ...
        public string LoadMovies(PageInfo page)
        {
            ...
            data.Add(new { ID = "97", MovieId = "1", MovieName = "军师联盟", TotalJiShu = "40", Operation = "123", ImgPath = "/Image/xueyingcode.jpg" });
            data.Add(new { ID = "98", MovieId = "1", MovieName = "军师联盟", TotalJiShu = "40", Operation = "123", ImgPath = "http://localhost:53162/Image/xueyingcode.jpg" });
            data.Add(new { ID = "99", MovieId = "1", MovieName = "军师联盟", TotalJiShu = "40", Operation = "123", ImgPath = "http://localhost:53162/Image/xueyingcode.jpg" });
            //data.Add(new { ID = "97", MovieId = "1", MovieName = "军师联盟", TotalJiShu = "40", Operation = "123", ImgPath = "/Image/xueyingcode.jpg" });
            //data.Add(new { ID = "98", MovieId = "1", MovieName = "军师联盟", TotalJiShu = "40", Operation = "123", ImgPath = "http://localhost:53162/Image/xueyingcode.jpg" });
            //data.Add(new { ID = "99", MovieId = "1", MovieName = "军师联盟", TotalJiShu = "40", Operation = "123", ImgPath = "http://localhost:53162/Image/xueyingcode.jpg" });
            //data.Add(new { ID = "97", MovieId = "1", MovieName = "军师联盟", TotalJiShu = "40", Operation = "123", ImgPath = "/Image/xueyingcode.jpg" });
